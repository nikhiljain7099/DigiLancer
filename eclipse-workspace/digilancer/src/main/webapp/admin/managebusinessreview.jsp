      ...
      <div class="page-content">
        	...
        	<div style="width:90%" class="card mb-0 mt-4">
                  <div class="card-header">
                    <h3 class="h4 mb-0">Business's Review</h3>
                  </div>
                      ...
                      <table class="table mb-0 table-striped table-hover">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>Otto</td>
                            <td>@mdo</td>
                            <td>The company was very co-operative throughout the project</td>
                            <td>Insta Ads</td>
                            <td>Nikhil Jain</td>
                            <td> <!-- Delete button -->
                          ...
                          <tr>
                            ...
                            <td>Thornton</td>
                            <td>@fat</td>
                            <td>It was nice working with this company I am looking for many new projects to work with them</td>
                          ...
                          <tr>
                            ...
                            <td>The project was very good to work with but the company was not as co-operative as i wanted asking again and again for project updates even thought the project's deadline was a lot later</td>
                            <td>Reels Editing</td>
                            <td>Shubham Jain</td>
                            <td> <!-- Delete button -->
                            <button type="button" class="btn btn-danger">Delete</button>
	    ...
	    document.addEventListener("DOMContentLoaded", function() {
	        ...
	        searchInput.addEventListener("keyup", function(event) {
	            ...
	            tableRows.forEach(function(row) {
	                ...
	                const companyName = row.cells[3].textContent.toLowerCase();
