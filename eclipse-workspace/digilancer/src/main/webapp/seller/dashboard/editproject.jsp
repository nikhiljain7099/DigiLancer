	...
	<div class="form_wrapper">
	  <div class="form_container">
	    <div class="title_container">
	      <h2>Edit <%= category %> Project</h2>
	    </div>
	    <div class="row clearfix">
	      <div class="">
	        <form action="congratulations.jsp" style="width:840px;">
	          ...
	          <div class="input_field"> 
	            <textarea style="padding:3px 10px 0px 35px; height:100px;" class="w-100" row="30" col="30" type="text" name="description" placeholder="Project Description" required></textarea>
	          </div>
	          <div class="input_field"> 
	            <input type="text" name="minamount" placeholder="Minimum Project Amout" required />
	          </div>
	          <div class="input_field"> 
	            <input type="text" name="maxamount" placeholder="Maximum Project Amount" required />
	          </div>
