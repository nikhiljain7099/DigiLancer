...
<body onload="hideAlert()">
  ...
  <div class="form_container">
    <div class="title_container">
      ...
      %>
      <div class="alert alert-success mb-0" id="successAlert" role="alert">
	  	Successfully Registered
	  </div>
	   <% }
          msg = msgAttribute.toString();
    ...
    <div class="row clearfix">
      <div class="">
        <form action="http://localhost:8080/digilancer/FreelancerController" method="post" style="width:840px;">
          ...
          <input name="action" class="button" type="submit" value="Login" />
        </form>
      </div>
    </div>
  </div>
