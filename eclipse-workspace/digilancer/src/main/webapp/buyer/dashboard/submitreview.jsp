	...
	<div class="form_wrapper">
        <div class="form_container">
            ...
            <div class="row clearfix">
                <div class="">
                    <form action="../../FreelancerReviewController" method="post" style="width:840px;" onsubmit="return validateForm()">
                        ...
                        <input type="hidden" value="<%=request.getParameter("freelancerid") %>" name="freelancerid"/>
                        <%ClientModel cmodel = (ClientModel) session.getAttribute("cmodel");  %>
                        <input type="hidden" value="<%=cmodel.getclientId() %>" name="clientid"/>
